...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries = new HashSet(){{
           ...
           add(new Serie("70s show", "comedia", 25));
        }};
        ...
        minhasSeries2.add(new Serie("70s show", "comedia", 25));
        ...
        minhasSeries4.add(new Serie("dark", "guerra", 40));
        minhasSeries4.add(new Serie("got", "fantasia", 59));
...
//Pra você
        ...
        minhasSeries5.add(new Serie("La casa de Papel", "acao", 50));
